  ...
  def main(args: Array[String]): Unit = {
    ...
    println(
      "Insert 1 for easy, 2 for medium or 3 for hard: \n" +
        "To reveal a Field Cell type in the coordinates as for example: 00, \n" +
        "if you want to place a Flag in this Field write a f behind the coordinates \n" +
